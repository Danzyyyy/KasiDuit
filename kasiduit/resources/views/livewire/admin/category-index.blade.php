<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        @if (session()->has('message'))
            <div class="px-4 py-2 bg-green-100 text-green-700 rounded-lg text-sm font-medium animate-fade-in-up border border-green-200 mb-4">
                {{ session('message') }}
            </div>
        @endif
        ...
        @if (session()->has('error'))
            <div class="px-4 py-2 bg-red-100 text-red-700 rounded-lg text-sm font-medium animate-fade-in-up border border-red-200 mb-4 flex items-center gap-2">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                    ...
                    <span class="bg-white border border-gray-200 text-gray-600 text-xs font-bold px-2.5 py-1 rounded-md shadow-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150 group">
                                ...
                                <td class="p-4 text-right space-x-2">
                                    <button wire:click="edit({{ $cat->id }})" class="p-2 rounded-lg text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition">
                                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                    </button>
                                    <button wire:click="delete({{ $cat->id }})" wire:confirm="Apakah Anda yakin ingin menghapus kategori '{{ $cat->name }}'?" class="p-2 rounded-lg text-gray-400 hover:text-red-600 hover:bg-red-50 transition">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 sticky top-8 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 text-xs pointer-events-none">/</span>
                    ...
                    <div class="pt-4 flex gap-3">
                        @if($editMode)
                            <button wire:click="resetForm" type="button" class="flex-1 py-3 border border-gray-300 text-gray-600 font-bold rounded-xl hover:bg-gray-50 transition text-sm">
                                Batal
                            </button>
                        @endif
