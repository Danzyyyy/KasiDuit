...
class CampaignManager extends Component
{
    ...
    // Properti Form
    public $title, $category_id, $target_amount, $deadline, $full_description, $image, $old_image;
    public $status = 'pending';
    public $location_display = null;
    ...
    public function viewDetail($id)
    {
        ...
        $this->location_display = $this->campaign->district_name ? $this->campaign->district_name . ', ' . $this->campaign->regency_name : null;
    ...
    public function edit($id)
    {
        ...
        $this->location_display = $camp->district_name ? $camp->district_name . ', ' . $camp->regency_name : null;
